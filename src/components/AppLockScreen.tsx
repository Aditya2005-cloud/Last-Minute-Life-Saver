      ...
      <div className="max-w-md w-full text-center space-y-8 z-10">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <p className="text-zinc-500 text-xs">
            DeadlineGenie physical security protection. Enter your 4-digit PIN
            to decrypt sessions.
          </p>
        </div>
            ...
            {showEmergencyReset && (
              ...
              >
                ...
                <p className="text-[10px] text-zinc-400 leading-relaxed">
                  For safety, your database is secured. If you forgot your
                  password or got locked out, click the button below to
                  completely clear your browser's local sandbox storage and
                  start anew.
                </p>
                <button
